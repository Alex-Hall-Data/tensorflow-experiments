# -*- coding: utf-8 -*-
"""
Created on Fri Oct 27 07:42:32 2017
...
#find and get rid of common entries in train test and valid sets
...
LR_model.fit(train_dataset[:1000,:,:].reshape(1000,-1), train_labels[:1000])
LR_model.score(test_dataset[:1000,:,:].reshape(1000,-1),test_labels[:1000])
